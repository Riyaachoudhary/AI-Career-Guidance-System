    ...
    <div className='space-y-6'>
        ...
        {data.length === 0 ? (
            <div className='text-center py-8 text-gray-500'>
                <GraduationCap className='w-12 h-12 mx-auto md-3 text-gray-300'/>
                ...
                {data.map((education, index)=>(
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            type="text"  placeholder='Degree(e.g., B.Tech, M.Tech)' className='px-3 py-2 text-sm '/>
                        ...
                        <input value={education.cgpa || ""} onChange={(e)=>updateEducation(index,"cgpa", e.target.value)} 
                            type="text" className=' w-full px-3 py-2 text-sm  border-gray-300 rounded-lg focus:ring-blue-500 outline-none' placeholder='cgpa (optional)'
                        />
