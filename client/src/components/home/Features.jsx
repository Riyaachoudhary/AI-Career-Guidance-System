...
const [isHover, setIsHover] = React.useState(false);
  ...
  return (
        ...
        <Title title='Build your resume' description='Our streamlined process helps you create a professional resume in minutes with intellligent AI-powered tools and features.'/>
